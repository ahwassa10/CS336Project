		...
		*/
		...
		while(result1.next()){
			...
			*/
			...
			//out.print(result1.getString("is_international"));
			out.print("</td>");
	...
	if(!result2.isBeforeFirst()){
		...
		*/
		...
		while(result2.next()){
			...
			/*
			out.print("<td>");
			out.print(result2.getString("flight_fare"));
			out.print("</td>");
			*/
		
			out.print("<td>");
			out.print(result2.getString("departure_date"));
			out.print("</td>");
			...
			out.print("<td>");
			out.print(result2.getString("arrival_date"));
			out.print("</td>");
			...
			out.print("<td>");
			if(result2.getString("is_international").equals("0")){
				out.print("No");
			} else {
				out.print("Yes");
			}
			...
			out.print("<td>");
			out.print(result2.getString("seats_available"));
			out.print("</td>");
